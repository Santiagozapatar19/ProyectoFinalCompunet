...
set CLASSPATH=%APP_HOME%\lib\worker-1.0.jar;%APP_HOME%\lib\ice-3.7.10.jar


@rem Execute worker
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WORKER_OPTS%  -classpath "%CLASSPATH%" Demo.WorkerApp %*
