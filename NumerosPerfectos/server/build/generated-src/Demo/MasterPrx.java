...
{
    default void addWorker(String workerId, WorkerPrx worker)
    {
        addWorker(workerId, worker, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addWorker(String workerId, WorkerPrx worker, java.util.Map<String, String> context)
    {
        _iceI_addWorkerAsync(workerId, worker, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> addWorkerAsync(String workerId, WorkerPrx worker)
    {
        return _iceI_addWorkerAsync(workerId, worker, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addWorkerAsync(String workerId, WorkerPrx worker, java.util.Map<String, String> context)
    {
        return _iceI_addWorkerAsync(workerId, worker, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addWorkerAsync(String iceP_workerId, WorkerPrx iceP_worker, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default long[] arrangeAnswer(long start, long end)
    {
        return arrangeAnswer(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long[] arrangeAnswer(long start, long end, java.util.Map<String, String> context)
    {
        return _iceI_arrangeAnswerAsync(start, end, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<long[]> arrangeAnswerAsync(long start, long end)
    {
        return _iceI_arrangeAnswerAsync(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<long[]> arrangeAnswerAsync(long start, long end, java.util.Map<String, String> context)
    {
        return _iceI_arrangeAnswerAsync(start, end, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<long[]> _iceI_arrangeAnswerAsync(long iceP_start, long iceP_end, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<long[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "arrangeAnswer", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeLong(iceP_start);
                     ostr.writeLong(iceP_end);
                 }, istr -> {
                     long[] ret;
