...
set CLASSPATH=%APP_HOME%\lib\client-1.0.jar;%APP_HOME%\lib\server-1.0.jar;%APP_HOME%\lib\ice-3.7.10.jar


@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" Demo.Client %*
