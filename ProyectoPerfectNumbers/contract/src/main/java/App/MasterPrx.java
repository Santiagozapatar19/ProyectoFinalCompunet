...
{
    default void findPerfectNumbers(long start, long end, ClientCallbackPrx cb)
    {
        findPerfectNumbers(start, end, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void findPerfectNumbers(long start, long end, ClientCallbackPrx cb, java.util.Map<String, String> context)
    {
        _iceI_findPerfectNumbersAsync(start, end, cb, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> findPerfectNumbersAsync(long start, long end, ClientCallbackPrx cb)
    {
        return _iceI_findPerfectNumbersAsync(start, end, cb, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> findPerfectNumbersAsync(long start, long end, ClientCallbackPrx cb, java.util.Map<String, String> context)
    {
        return _iceI_findPerfectNumbersAsync(start, end, cb, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_findPerfectNumbersAsync(long iceP_start, long iceP_end, ClientCallbackPrx iceP_cb, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "findPerfectNumbers", null, sync, null);
