...
{
    default String[] findPerfectNumbers(long start, long end)
    {
        return findPerfectNumbers(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String[] findPerfectNumbers(long start, long end, java.util.Map<String, String> context)
    {
        return _iceI_findPerfectNumbersAsync(start, end, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String[]> findPerfectNumbersAsync(long start, long end)
    {
        return _iceI_findPerfectNumbersAsync(start, end, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> findPerfectNumbersAsync(long start, long end, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<String[]> _iceI_findPerfectNumbersAsync(long iceP_start, long iceP_end, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "findPerfectNumbers", null, sync, null);
